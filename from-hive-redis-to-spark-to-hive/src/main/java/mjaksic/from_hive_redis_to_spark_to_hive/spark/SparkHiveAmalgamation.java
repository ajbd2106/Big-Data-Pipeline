...
import mjaksic.from_hive_redis_to_spark_to_hive.redis.InstancePool;
import mjaksic.from_hive_redis_to_spark_to_hive.redis.InstancePoolConfiguration;
import mjaksic.from_hive_redis_to_spark_to_hive.sql.SelectConfiguration;
import mjaksic.from_hive_redis_to_spark_to_hive.sql.SelectConstructor;
...
/**
 * Interacts with Spark and Hive both.
 */
public class SparkHiveAmalgamation implements Closeable {
    ...
    private List GetAllIPAlarmTypeKeys() {
        ...
        String[] filter_columns = key_columns.split(","); //TODO, make the data clean so that you don't have to filter it
    ...
    /**
     * Filters all non null.
     * TIMESTAMP, INT and similar data types that cannot have a String "NONE" as a value have null instead.
    ...
    /**
     * Warning: moves data into the application's driver process! May cause OutOfMemoryError! See a link below.
    ...
    private String GetRedisInventory(Row not_up_alarm) {
        ...
        Jedis inventory:
        KEY:tipid,        VALUE:1
        KEY:vendor,       VALUE:Technicolor
        KEY:productnumber,VALUE:TG788vnv2
        KEY:silocationid, VALUE:142391
        KEY:dnsname,      VALUE:c-CP1426SAFFA-TG788vnv2
        KEY:cisid,        VALUE:161099
        */
