package mjaksic.from_kafka_to_hive.spark;
...
public class SparkHiveSessionConfiguration {
    ...
    /**
     *
     * @param master See a link below.
     * @param app_name Application name.
     * @param spark_sql_warehouse_dir Location of the Hive metastore. See a link below.
     * @param hive_metastore_uris  See a link below.
