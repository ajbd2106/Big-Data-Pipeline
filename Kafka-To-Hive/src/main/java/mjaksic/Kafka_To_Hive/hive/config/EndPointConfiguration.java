...
public class EndPointConfiguration {
    ...
    /**
     *
     * @param hive_metastore_uri A Hive metastore URI. See the link below.
     * @param table_in_database Table in a database. See the link below.
     * @param partition_values Can be null. See the link below.
