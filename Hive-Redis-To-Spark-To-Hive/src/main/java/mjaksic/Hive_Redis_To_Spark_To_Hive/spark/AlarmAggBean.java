...
/**
 * Hive table Java bean class.
 * In short, a bean must have: an empty Constructor
 *                             all fields set to private
 *                             setters and getters for all fields
 * @see <a href="http://www.oracle.com/technetwork/java/javase/documentation/spec-136004.html">Java Bean Standard</a>
 */
public class AlarmAggBean implements Serializable { //TODO couple Hive table and the bean; Single Responsibility Principle, if the table changes, the bean should change as well
